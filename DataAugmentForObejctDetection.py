...
if __name__ == '__main__':
    ...
    save_pic_folder = os.path.join(os.path.abspath(os.path.join(source_pic_root_path,'..')),'Aug_JPEGImages')
    save_xml_folder = os.path.join(os.path.abspath(os.path.join(source_xml_root_path,'..')),'Aug_Annotations')
    ...
    #source_pic_root_path = '/home/nvidia/MXNet/utils/png2jpg'  # 图片原始位置
    #source_xml_root_path = '/home/nvidia/MXNet/utils/xml_final'  # xml的原始位置

    #save_pic_folder = '/home/nvidia/MXNet/utils/Aug_JPEGImages'  # 图片增强结果保存文件
    #save_xml_folder = '/home/nvidia/MXNet/utils/Aug_Annotations'  # xml增强结果保存文件
